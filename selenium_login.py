...
class TestOnlineLogin:
    ...
    def expected_result(self):
        return {
            "login_success_page": "https://practicetestautomation.com/logged-in-successfully/",
            "login_failure_page": "https://practicetestautomation.com/practice-test-login/",
        }
    ...
    def test_login_with_successful_info(self):
        self.set_up()
    ...
    def test_login_with_incorrect_username(self):
        ...
        self.driver.get(self.web_url)
        username_elem = self.driver.find_element(by=By.NAME, value="username")
        username_elem.send_keys("student123")
        ...
        assert self.driver.current_url == self.expected_result["login_failure_page"]

        error_hint_elem = self.driver.find_element(by=By.ID, value="error")
        assert error_hint_elem.text == "Your username is invalid!"
    ...
    def test_login_with_incorrect_password(self):
        ...
        error_hint_elem = self.driver.find_element(by=By.ID, value="error")
        assert error_hint_elem.text == "Your password is invalid!"
